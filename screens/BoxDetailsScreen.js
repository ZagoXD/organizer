...
const styles = StyleSheet.create({
  ...
  TopBarContainer: { display: 'flex', alignItems: 'center', width: '100%', flexDirection: 'row', marginBottom: 10 },
  searchContainer: { flexDirection: 'row', alignItems: 'center', borderWidth: 1, paddingHorizontal: 10, borderColor: '#ccc', borderRadius: 5, backgroundColor: '#f9f9f9', flex: 1, height: 40, marginVertical: 10 },
  searchIcon: { marginRight: 8 },
  searchInput: { flex: 1, paddingVertical: 10, fontSize: 16, color: '#333' },
  floatingButton: { backgroundColor: '#5db55b', width: 40, height: 40, borderRadius: 30, alignItems: 'center', justifyContent: 'center', elevation: 5, zIndex: 1000, marginLeft: 10 },
  cancelBtnAddItem: { marginTop: 20 },
  title: { fontSize: 24, fontWeight: 'bold', marginBottom: 20 },
  iconItem: { marginRight: 8 },
  ...
  itemContainer: { flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', padding: 20, borderRadius: 5, marginBottom: 10 },
  itemInfo: { flex: 1, marginRight: 10 },
  itemName: { fontSize: 18, maxWidth: '80%', flexWrap: 'wrap', fontWeight: 'bold' },
  itemQuantity: { fontSize: 16, color: '#888' },
  itemActions: { flexDirection: 'row', justifyContent: 'space-between', width: 70 },
  addButton: { marginTop: 20, padding: 15, backgroundColor: '#5db55b', alignItems: 'center', borderRadius: 5 },
  addButtonText: { color: '#fff', fontSize: 18 },
  modalContainer: { flex: 1, justifyContent: 'center', alignItems: 'center', backgroundColor: 'rgba(0, 0, 0, 0.5)' },
  modalView: { width: '85%', padding: 35, backgroundColor: 'white', borderRadius: 10, shadowColor: '#000', shadowOffset: { width: 0, height: 2 }, shadowOpacity: 0.25, shadowRadius: 4, elevation: 5 },
  modalTitle: { fontSize: 20, fontWeight: 'bold', marginBottom: 15, textAlign: 'center' },
  input: { height: 50, borderColor: '#ccc', borderWidth: 1, borderRadius: 5, paddingHorizontal: 10, marginBottom: 15 },
  modalButton: { width: '100%', backgroundColor: '#5db55b', paddingVertical: 15, borderRadius: 10, alignItems: 'center', marginBottom: 10 },
  modalButtonText: { color: '#fff', fontSize: 18, fontWeight: 'bold' },
  cancelButton: { width: '100%', backgroundColor: '#fff', paddingVertical: 15, borderRadius: 10, borderWidth: 1, borderColor: '#ccc', alignItems: 'center' },
